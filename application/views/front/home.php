      ...
      <div class="col-lg-12">
        ...
        <div class="counter-container">
          <div class="counter-cell">
            <div data-purecounter-start="0" data-purecounter-end="<?php echo $total_koperasi ?>" data-purecounter-duration="3" class="purecounter">1</div>
            <div class="counter-info">Jumlah Koperasi Aktif</div>
          </div>
          <!-- end of counter-cell -->
          <div class="counter-cell">
            <div data-purecounter-start="0" data-purecounter-end="<?php echo $total_umkm ?>" data-purecounter-duration="3" class="purecounter">1</div>
            <div class="counter-info">Jumlah UMKM</div>
          </div>
          <!-- end of counter-cell -->
          <div class="counter-cell">
            <div data-purecounter-start="0" data-purecounter-end="<?php echo $total_industri ?>" data-purecounter-duration="3" class="purecounter">1</div>
            <div class="counter-info">Jumlah Industri</div>
          </div>
          <!-- end of counter-cell -->
          <div class="counter-cell">
            <div data-purecounter-start="0" data-purecounter-end="<?php echo $total_pasar ?>" data-purecounter-duration="3" class="purecounter">1</div>
