  ...
  <body>
    ...
    <section id="about">
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>TUGAS POKOK DAN FUNGSI BIDANG PERDAGANGAN</h2>
          </div>
        </div>
        <div class="row">
    ...
    <section id="syarat">
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>SYARAT PENDIRIAN PERDAGANGAN</h2>
          </div>
        </div>
        <div class="col justify-content-center fs-5 text-justify">
    ...
    <section id="about">
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>STRUKTUR ORGANISASI BIDANG PERDAGANGAN</h2><br>
              <div class="container">
                <div class="row">
                  <div class="col">
                    <h4>Kepala Bidang Perdagangan</h4>
                    <h5>Ibu Yati</h5>
                  </div>
              </div>
                <div class="row">
    ...
    <section id="about">
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>DATA HARGA BARANG POKOK DAN BARANG PENTING</h2>
          </div>
        </div>
      </div>
    </section>
